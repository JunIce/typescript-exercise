...
const twelve_days_1 = require("./twelve-days");
describe('verse', () => {
    ...
    xit('second day two turtle doves', () => {
        ...
        expect(twelve_days_1.default.recite(2, 2)).toEqual(expected);
    });
    xit('third day three french hens', () => {
        ...
        expect(twelve_days_1.default.recite(3, 3)).toEqual(expected);
    });
    xit('fourth day four calling birds', () => {
        ...
        expect(twelve_days_1.default.recite(4, 4)).toEqual(expected);
    });
    xit('fifth day five gold rings', () => {
        ...
        expect(twelve_days_1.default.recite(5, 5)).toEqual(expected);
    });
    xit('sixth day six geese-a-laying', () => {
        ...
        expect(twelve_days_1.default.recite(6, 6)).toEqual(expected);
    });
    xit('seventh day seven swans-a-swimming', () => {
        ...
        expect(twelve_days_1.default.recite(7, 7)).toEqual(expected);
    });
    xit('eighth day eight maids-a-milking', () => {
        ...
        expect(twelve_days_1.default.recite(8, 8)).toEqual(expected);
    });
    xit('ninth day nine ladies dancing', () => {
        ...
        expect(twelve_days_1.default.recite(9, 9)).toEqual(expected);
    });
    xit('tenth day ten lords-a-leaping', () => {
        ...
        expect(twelve_days_1.default.recite(10, 10)).toEqual(expected);
    });
    xit('eleventh day eleven pipers piping', () => {
        ...
        expect(twelve_days_1.default.recite(11, 11)).toEqual(expected);
    });
...
describe('lyrics', () => {
    ...
    xit('recites the whole song', () => {
        ...
        expect(twelve_days_1.default.recite(1, 12)).toEqual(expected);
    });
});
//# sourceMappingURL=twelve-days.test.js.map